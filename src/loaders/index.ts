...
export default async ({ expressApp }) => {
  ...
  require('../models/address').default.hasOne(require('../models/purchase-order').default, {
    foreignKey: 'po_vend',
    sourceKey: 'ad_addr',
  });
  require('../models/purchase-order').default.belongsTo(require('../models/address').default, {
    foreignKey: 'po_vend',
    targetKey: 'ad_addr',
  });
