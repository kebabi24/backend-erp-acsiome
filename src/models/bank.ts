...
const Bank = sequelize.define(
  'bank',
  {
    ...
    bk_balance: { type: Sequelize.DECIMAL, defaultValue: 0 },
    bk_2000: { type: Sequelize.DECIMAL, defaultValue: 0 },
    bk_1000: { type: Sequelize.DECIMAL, defaultValue: 0 },
    bk_0500: { type: Sequelize.DECIMAL, defaultValue: 0 },
    bk_0200: { type: Sequelize.DECIMAL, defaultValue: 0 },
    bk_p200: { type: Sequelize.DECIMAL, defaultValue: 0 },
    bk_p100: { type: Sequelize.DECIMAL, defaultValue: 0 },
    bk_p050: { type: Sequelize.DECIMAL, defaultValue: 0 },
    bk_p020: { type: Sequelize.DECIMAL, defaultValue: 0 },
